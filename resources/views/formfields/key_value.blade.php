...
<script>
    ...
    function addRowKV(){
        ...
        new_row.querySelector("#key").setAttribute('name', editNameCountKV(new_row.querySelector("#key")));
        new_row.querySelector("#key").value = '';
        new_row.querySelector("#value").setAttribute('name', editNameCountKV(new_row.querySelector("#value")));
